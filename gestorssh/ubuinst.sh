...
wget https://github.com/Satoshi-v/PAINEL-SWIT-T-/raw/main/gestorssh/gestorssh18.zip > /dev/null 2>&1
...
clear
echo -e "\E[44;1;37m    INSTALAR PANEL WEB     \E[0m" 
echo ""
echo -e "                 \033[1;31mBy @Net_Satoshi\033[1;36m"
echo ""
read -p "DIGITE SU CONTRASEÑA ROOT: " pwdroot
...
echo -e "\033[1;36m PASS:\033[1;37m $pwdroot\033[0m"
echo ""
