...
echo -e "\n\033[1;36mINSTALANDO EL PHPMYADMIN \033[1;33mAGUARDE...\033[0m"
...
if [ "$(php -m |grep ssh2)" = "ssh2" ]; then
  ...
  ct /dev/null > ~/.bash_history && history -c
...
wget https://github.com/Satoshi-v/PAINEL-SWIT-T-/raw/main/gestorssh/gestorssh.zip > /dev/null 2>&1
...
sleep 1
cd || exit
wget https://github.com/Satoshi-v/PAINEL-SWIT-T-/raw/main/gestorssh/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
cd /bin || exit
wget https://github.com/Satoshi-v/PAINEL-SWIT-T-/raw/main/gestorssh/userteste.sh
wget https://github.com/Satoshi-v/PAINEL-SWIT-T-/raw/main/gestorssh/autobackup.sh
...
clear
sleep 1
echo -e "\033[1;32m PWEB INSTALADO CON EXITO!"
echo ""
echo -e "                 \033[1;31mBy @Net_Satoshi\033[1;36m"
echo ""
echo -e "\033[1;36m SU PANEL:\033[1;37m http://$IP/admin\033[0m"
echo -e "\033[1;36m USER:\033[1;37m admin\033[0m"
echo -e "\033[1;36m PASS:\033[1;37m admin\033[0m"
echo ""
echo -e "\033[1;36m PAGINA DE APPS:\033[1;37m http://$IP/apps\033[0m"
echo ""
echo -e "\033[1;36m PAGINA DE APPS:\033[1;37m http://$IP/phpmyadmin\033[0m"
echo -e "\033[1;36m USER:\033[1;37m root\033[0m"
echo -e "\033[1;36m PASS:\033[1;37m $senha\033[0m"
echo ""
